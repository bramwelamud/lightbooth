      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="space-y-8 mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white text-center lg:text-left">
           Рост выручки на 291 000 ₽ в месяц
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="space-y-6">
              <p className="text-base sm:text-lg lg:text-xl text-gray-300 leading-relaxed">
               В среднем мы приносим заведению до 530 дополнительных заказов в месяц — это около 291 000 ₽ выручки, если считать по средней стоимости коктейля. Такой результат достигается за счет привлечения гостей и с точной работы с вниманием гостей: реклама на странице скачивания фото, персональные предложения в мессенджерах, вовлечение в промо-акции. Вы продаёте больше — потому что мы привлекаем гостей и управляем их вниманием.
              </p>
            </div>
          </div>
